...
CREATE TABLE `businesses_categories` (
  ...
  KEY `index_businesses_categories_on_business_id` (`business_id`),
  KEY `index_businesses_categories_on_category_id` (`category_id`),
  CONSTRAINT `businesses_categories_ibfk_2` FOREIGN KEY (`category_id`) REFERENCES `categories` (`name`),
  CONSTRAINT `businesses_categories_ibfk_1` FOREIGN KEY (`business_id`) REFERENCES `businesses` (`business_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `businesses_neighborhoods` (
  `business_id` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `neighborhood_id` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  KEY `index_businesses_neighborhoods_on_business_id` (`business_id`),
  KEY `index_businesses_neighborhoods_on_neighborhood_id` (`neighborhood_id`),
  CONSTRAINT `businesses_neighborhoods_ibfk_2` FOREIGN KEY (`neighborhood_id`) REFERENCES `neighborhoods` (`name`),
  CONSTRAINT `businesses_neighborhoods_ibfk_1` FOREIGN KEY (`business_id`) REFERENCES `businesses` (`business_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `businesses_schools` (
  ...
  KEY `index_businesses_schools_on_business_id` (`business_id`),
  KEY `index_businesses_schools_on_school_id` (`school_id`),
  CONSTRAINT `businesses_schools_ibfk_2` FOREIGN KEY (`school_id`) REFERENCES `schools` (`name`),
  CONSTRAINT `businesses_schools_ibfk_1` FOREIGN KEY (`business_id`) REFERENCES `businesses` (`business_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-03-28 14:43:33
